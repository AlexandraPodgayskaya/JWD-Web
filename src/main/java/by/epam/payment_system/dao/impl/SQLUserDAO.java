...
public class SQLUserDAO implements UserDAO {
	...
	private static final String PARAMETR_USER_ID = "id";
	private static final String PARAMETR_USER_TYPE = "type";
	...
	public User find(UserInfo loginationInfo) throws DAOException {
		...
		try {
			...
			if (resultSet.next()) {
				int id = resultSet.getInt(PARAMETR_USER_ID);
				String type = resultSet.getString(PARAMETR_USER_TYPE);
