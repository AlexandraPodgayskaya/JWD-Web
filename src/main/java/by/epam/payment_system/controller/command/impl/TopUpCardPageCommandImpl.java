...
public class TopUpCardPageCommandImpl implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute(ATTRIBUTE_PAGE, THIS_PAGE + PARAMETER_NUMBER_CARD
				+ request.getParameter(NUMBER_CARD) + PARAMETER_CURRENCY + request.getParameter(CURRENCY)); 
