...
public interface CardService {
	 ...
	 */
	List<Card> takeCards(Long userId) throws ServiceException;
	 ...
	 */
	List<Card> takeCardsForTransfer(Long userId, String numberAccount, String currency) throws ServiceException;
	 ...
	 * @throws ServiceException if userId is null or {@link DAOException} occurs
	 */
	CardInfo takeAllCardOptions(Long userId) throws ServiceException;
	 ...
	 */
	void openAdditionalCard(Card card, String personalNumberPassport, Long userId) throws ServiceException;
